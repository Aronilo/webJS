...
modal_model.addEventListener("click", (e) => {
  ...
  if (
    ...
    modal_model.classList.add("modal_hidden");
    shouldStop = true;
    modal_content_body.style.display = "block";
    console.log("shouldStop:", shouldStop);
  }
});
  ...
  fetch(`/models`)
    ...
    .then((data) => {
      ...
      data.forEach((element) => {
        ...
        buttonRed.innerHTML = "Редактировать";
        buttonRed.classList.add("btn_show");
        buttonRed.dataset.id = element._id;
        const buttonShow = document.createElement("button");
        buttonShow.innerHTML = "Показать";
        buttonShow.classList.add("btn_show_mod");
...
table.addEventListener("click", (e) => {
  ...
  if (e.target.classList.contains("btn_show") || e.target.classList.contains("btn_show_mod")) {
    if (e.target.classList.contains("btn_show_mod"))
    {
      modal_content_body.style.display = "none";
    } else
    {
      modal_content_body.style.display = "block";
    }
...
let cubeMaterial = new THREE.MeshLambertMaterial({ color: "#CCCCFF" });
